...
class Login extends CI_Controller {
    ...
    public function index()
    {
		...
		curl_setopt_array($curl, array(
		  CURLOPT_URL => "https://simpeg.kalbarprov.go.id/simpeg-api/agama",
		  ...
		  CURLOPT_HTTPHEADER => array(
			"Token: eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VybmFtZSI6ImFwaS11c2VyLWJwc2RtIiwidGltZXN0YW1wIjoxNTkxODg3OTQxfQ.vtVx0qY9i-jXI_lspdBlT5_YxwVw7Oxt16Rs4f_2a1c",
		...
		if ($err) {
		  ...
		  $data_agama = json_decode($response);
		  foreach($data_agama as $value) { 
				$data = array(
				'id_agama'=>$value->kagama,
				'nama_agama'=>$value->nagama
			);
