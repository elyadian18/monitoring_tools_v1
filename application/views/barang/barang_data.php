<div class="row">
    <div class="col-lg-12"><br />
        ...
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url('barang'); ?>">Tools</a></li>
...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <?php echo anchor('barang/create', 'Tambah', array('class' => 'btn btn-successy btn-sm')); ?>
            <?= anchor('laporan/cetak_barang', 'Cetak', array('class' => 'btn btn-successy btn-sm')); ?>
            </div>
            <!-- /.panel-heading -->
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <input type="hidden" name="idhapus" id="idhapus">
                <p>Apakah anda yakin ingin menghapus tools <strong class="text-konfirmasi"> </strong> ?</p>
        </div>
        <div class="modal-footer">
        <button type="button" class="btn btn-successy btn-xs" data-dismiss="modal">Batal</button>
