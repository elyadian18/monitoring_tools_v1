<div class="row">
    <div class="col-lg-12"><br />
        ...
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url('barang/create'); ?>">Tools</a></li>
            <li class="active">Masukkan Data Tools</li>
        </ol>
        ...
        <div class="panel panel-default">
            ...
            <?php echo form_open_multipart('barang/insert', array('class' => 'form-horizontal', 'id' => 'jvalidate')) ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="kode_barang" class="form-control" placeholder="Kode Tools" value="<?php echo set_value('kode_barang'); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="nama_barang" class="form-control" placeholder="Nama Tools" value="<?php echo set_value('nama_barang'); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        echo form_dropdown('jenis_barang', $array, set_value('nama_jenis'),"class='form-control'");
                        ?>
                    </div>
                </div>
