...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <?php echo anchor('karyawan/create', 'Tambah', array('class' => 'btn btn-successy btn-sm' )); ?>
            <?php echo anchor('laporan/cetak_karyawan','Cetak', array('class' => 'btn btn-successy btn-sm')); ?>
        </div>
            <!-- /.panel-heading -->
