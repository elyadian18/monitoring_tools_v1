...
<body>
    <div class="navbar navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo site_url('');?>"><img src="<?php echo base_url(); ?>/assets/img/logo/logo.png" width="60" height="30"></a>
        </div>
...
<div class="row">
    <div class="col-md-8 ">
        <h3 class="display-4" align="center">Aplikasi Monitoring Tools</h3>
        <img src="<?php echo base_url(); ?>assets/img/banner/img-lib.png" alt="Belum Tersedia" class="img-responsive">
    </div>
    <div class="col-md-4">
            <br><br><br><br><br><br>
                ...
                <form class="form-horizontal" role="form" action="        <?php echo site_url('login');?>" method="post">
                    ...
                    <div class="form-group last">
                        <div class="col-sm-offset-3 col-sm-9">
                            <button type="submit" name="proses" class="btn btn-default btn-block btn-sm">
                                Masuk</button>
                        </div>
                    </div>
                </form>
