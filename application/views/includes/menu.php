...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url('dashboard'); ?>"><img src="<?php echo base_url(); ?>/assets/img/logo/logo.png" width="60" height="30"></a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="<?php echo base_url('barang'); ?>"><i class="fa fa-desktop fa-fw"></i> Tools</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url('jenis'); ?>"><i class="fa fa-list fa-fw"></i> Jenis Tools</a>
                                </li>
                                <li>
