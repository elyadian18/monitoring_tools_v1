<div class="row">
    <div class="col-lg-12"><br />
        ...
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url('users'); ?>">Pengguna</a></li>
...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <?php echo anchor('users/create', 'Tambah', array('class' => 'btn btn-successy btn-sm')); ?>
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <a href="<?php echo base_url('users/edit/'.$row->id_petugas) ?>"><input type="submit" class="btn btn-success btn-xs" name="edit" value="Ubah"></a>
