<div class="row">
    <div class="col-lg-12"><br />
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Ubah Data Kriteria</li>
        </ol>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            ...
            ?>
            <?php echo form_open('kriteria/update', array('class' => 'form-horizontal', 'id' => 'jvalidate')) ?>

                <div class="form-group">
                    <p class="col-sm-2 text-left">Kriteria </p>
                    <input type="hidden" name="id_kriteria" class="form-control" placeholder="Kriteria"
                        value="<?php echo $edit['id_kriteria'] ?>">

                    <div class="col-sm-10">
                        <input type="text" name="kriteria" class="form-control" placeholder="Kriteria"
                        value="<?php echo $edit['kriteria'] ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10" style="width:20%;">
                            ...
                            echo form_dropdown('atribut',$jenis_atribut,$edit['atribut'],"class='form-control'");
                            ?>
                    </div>
                </div>
                <div class="form-group">
