    ...
    <!-- <legend>Transaksi</legend> -->
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-inline">
                    ...
                    <div class="form-group ">
                        ...
                        <button id="tambah_barang" class="btn btn-successy"> Tambah Barang <i class="glyphicon glyphicon-plus"></i></button>
                    </div>
                    <div class="form-group">
            ...
            <div class="panel-footer">
                <button id="simpan" class="btn btn-successy"><i class="glyphicon glyphicon-hdd"></i> Simpan</button>
            </div>
        </div>
        <!-- end data barang -->
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <!--<button type="button" class="btn btn-successy" id="konfirmasi">Hapus</button>-->
        </div>
    </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div>
